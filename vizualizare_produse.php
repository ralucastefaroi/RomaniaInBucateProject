...
<head>
    ...
    <link rel="stylesheet" href="css/crud_produs.css">
    <meta charset="UTF-8">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="adaugare_produs.php" class="btn" style="background-color: #e6ccb3;color:#663300"><i class="fa fa-plus"></i> Adăugare produs</a><br><br>
                        <h2 class="text-center" style="color: #663300">Produse</h2>
                    </div>
                    <?php
                            ...
                            echo '<table class="table table-bordered">';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['pret'] . "</td>";
                                        echo "<td>";
                                            echo "<a href='update_produs.php?id=". $row['id_produs'] ."' class='mr-3' title='Editare produs' data-toggle='tooltip'><span class='fa fa-pencil'></span></a>";
                                            echo "<a href='stergere_produs.php?id=". $row['id_produs'] ."' title='Ștergere produs' data-toggle='tooltip'><span class='fa fa-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
